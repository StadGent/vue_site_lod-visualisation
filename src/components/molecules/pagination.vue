  ...
  <nav v-if="total > 1" class="pager" aria-labelledby="pagination_1">
    ...
    <ul class="pager__items">
      <li v-if="1 !== +active" class="previous">
        <router-link :to="{path: `${this.$route.path}#result`, query: Object.assign({}, $route.query,{page: +active-1})}"
                   class="previous"
                   @click.native="blur">
          vorige
      ...
      <li>
        <router-link :to="{path: `${this.$route.path}#result`, query: Object.assign({}, $route.query,{page: 1})}"
      ...
      <li v-if="+active !==1 && +active !== total">
        <router-link :to="{path: `${this.$route.path}#result`, query: Object.assign({}, $route.query,{page: +active})}"
      ...
      <li>
        <router-link :to="{path: `${this.$route.path}#result`, query: Object.assign({}, $route.query, {page: total})}"

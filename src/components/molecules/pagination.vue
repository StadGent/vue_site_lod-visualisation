<template>
  <nav v-if="total > 1" class="pager" aria-labelledby="pagination_1">
    ...
    <ul class="pager__items">
      ...
      <li>
        <router-link :to="{path: `${this.$route.path}#main`, query: Object.assign({}, $route.query,{page: 1})}"
      ...
      <li v-if="+active !==1 && +active !== total">
        <router-link :to="{path: `${this.$route.path}#main`, query: Object.assign({}, $route.query,{page: +active})}"
      ...
      <li>
        <router-link :to="{path: `${this.$route.path}#main`, query: Object.assign({}, $route.query, {page: total})}"
